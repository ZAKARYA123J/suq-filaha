...
export class AuthService {
    ...
    async sendOtp(phoneNumber) {
        try {
            ...
            const smsResponse = await sendViaIAMAPI(phoneNumber, `Your code is ${code}`);
    ...
    chatToken(userId, userType, phoneNumber, name) {
    ...
    generateToken(userId, userType) {
        ...
        return jwt.sign(payloud, config.jwtSecret, { algorithm: "HS256", expiresIn: config.jwtExpiration });
    }
